...
/// 俯冲衍生
/// </summary>
public class DiveDerive : SkillInBattle
{
    /// <summary>
    ...
    public IEnumerator Effect1(ParameterNode parameterNode)
    {
        ...
        if (gameObject.TryGetComponent(out Melee melee))
        {
            ...
            if (keyValuePairs.ContainsKey("Skill.DiveDerive.Effect1"))
            {
                currentValue = keyValuePairs["Skill.DiveDerive.Effect1"];
            }
            ...
            if (currentValue < GetSkillValue())
            {
                ...
                parameter1.Add("Source", "Skill.DiveDerive.Effect1");
    ...
    public bool Compare1(ParameterNode parameterNode)
    {
        ...
        if (monsterInBattle.gameObject != gameObject || skillName != "dive_derive")
        {
            return false;
        }
    ...
    public bool Compare2(ParameterNode parameterNode)
    {
        ...
        if (monsterInBattle.gameObject != gameObject || (skillName != "melee" && skillName != "ranged"))
        {
            return false;
        }
    ...
    public IEnumerator Effect4(ParameterNode parameterNode)
    {
        ...
        if (newSkillValue == -1)
        {
            ...
            parameter2.Add("Source", "Skill.DiveDerive.Effect1");
    ...
    public bool Compare4(ParameterNode parameterNode)
    {
        ...
        return monsterInBattle.gameObject == gameObject && skillName == "dive_derive" && newSkillValue != GetSkillValue();
    }
