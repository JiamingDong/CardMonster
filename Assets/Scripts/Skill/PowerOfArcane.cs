...
/// <summary>
/// 奥能之力
/// 我方战斗阶段开始时，所有盟友的<魔法>值永久+X，不具有<魔法>的盟友永久获得<魔法X>（X为%d）
/// </summary>
public class PowerOfArcane : SkillInBattle
{
                ...
                if (monsterGameObject == gameObject)
                {
                    for (int k = 2; k > -1; k--)
                    {
                        ...
                        if (go != null)
                        {
                            ...
                            parameter.Add("SkillName", "magic");
                            parameter.Add("SkillValue", GetSkillValue());
                            parameter.Add("Source", "Skill.PowerOfArcane.Effect1");
