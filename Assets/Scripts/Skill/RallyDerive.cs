...
public class RallyDerive : SkillInBattle
{
    ...
    public IEnumerator Effect1(ParameterNode parameterNode)
    {
        ...
        if (keyValuePairs.ContainsKey("Skill.RallyDerive.Effect1"))
        {
            currentValue = keyValuePairs["Skill.RallyDerive.Effect1"];
        }
        ...
        parameter1.Add("Source", "Skill.RallyDerive.Effect1");
    ...
    public bool Compare1(ParameterNode parameterNode)
    {
        ...
        if (monsterInBattle.gameObject != gameObject || skillName != "rally_derive")
        {
            return false;
        }
    ...
    public bool Compare4(ParameterNode parameterNode)
    {
        ...
        return monsterInBattle.gameObject == gameObject && skillName == "rally_derive" && newSkillValue != GetSkillValue();
    }
